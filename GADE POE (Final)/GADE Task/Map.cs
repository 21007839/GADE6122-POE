...
namespace GADE_Task
{
    ...
    public class Map
    {
        ...
        /// <summary>
        /// Returns an item at a specified position and removes it from the item array
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <returns></returns>
        public Item GetItemAtPosition(int x, int y)
        {
            ...
            // Searches through the item array until the correct item is found
            for (int i = 0; i < items.Length; i++)
            {
        ...
        /// <summary>
        /// The standard for a goblin attack
        /// </summary>
        ...
        /// <summary>
        /// The standard for a mage attack
        /// </summary>
        /// <param name="attacker"></param>
        public void MageAttack(Enemy attacker)
        {
            ...
            // The mage targets everyone within one square of it, including allies
            for (int i = -1; i <= 1; i++)
            {
                for (int j = -1; j <= 1; j++)
                {
        ...
        /// <summary>
        /// The standard for a leader attack
        /// </summary>
        /// <param name="attacker"></param>
        public void LeaderAttack(Enemy attacker)
        {
            attacker.Attack(hero);
        }
    }
